...
midi_file_path = None
model = None
neuralnote_path = "../NeuralNote/build/NeuralNote_artefacts/Debug/Standalone/NeuralNote.app/"  # Path to NeuralNote
model_size = 'large'
...
if __name__ == "__main__":
    ...
    inpainted, combined = process_midi_file(midi_file_path, start_time= 0.5, end_time = 4, model=model, time_unit='seconds')
